...
var self = exports = module.exports = {
    ...
    posts: async (_username, _limit) => {
        ...
        try {
            ...
            var response = await Axios.get(defaults.URL_INSTAGRAM_GRAPHQL_QUERY, {
                params: {
                    query_id: _query_id || defaults.INSTAGRAM_QUERY_USER_POSTS,
                    variables: {
                        id: _info.id,
    ...
    username: async (_id) => {
        try {
            ...
            console.log('Query ID for Username:', _query_id);

            if (_query_id === undefined || _query_id === null) {
                _query_id = defaults.INSTAGRAM_QUERY_USER_POSTS;
            }
