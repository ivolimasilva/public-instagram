...
exports = module.exports = {
    ...
    recent: async (_hashtag, _limit) => {
        ...
        try {
            ...
            var posts = await utils.parser.posts(response.data);
            ...
            while (posts.length < _limit && response.data.data.hashtag.edge_hashtag_to_media.page_info.has_next_page) {
                ...
                posts = posts.concat(await utils.parser.posts(response.data));
    ...
    top: async (_hashtag) => {
        try {
            ...
            return await utils.parser.top(response.data);
    ...
    search: async (_hashtag) => {
        try {
            ...
            return await utils.parser.hashtags(response.data);
