    ...
    comments: async (_shortcode, _limit) => {
        ...
        try {
            ...
            if (!response.data.graphql.shortcode_media.edge_media_to_comment.page_info.has_next_page) {
                ...
                while (_comments.length < _limit && response.data.graphql.shortcode_media.edge_media_to_comment.page_info.has_next_page) {

                    token = response.data.graphql.shortcode_media.edge_media_to_comment.page_info.end_cursor;
